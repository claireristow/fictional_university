...
function university_files() {
    wp_enqueue_script('googleMap', '//maps.googleapis.com/maps/api/js?key=AIzaSyCA0mOruzcb7OKgksvi8fbgx6erTmYcQsc', null, '1.0', true);
...
function universityMapKey($api) {
    $api['key'] = 'AIzaSyCA0mOruzcb7OKgksvi8fbgx6erTmYcQsc';
    return $api;
}
